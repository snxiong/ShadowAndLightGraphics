...
{	private GLCanvas myCanvas;
	...
	{	setTitle("Chapter8 - program 1");
		...
		ActionMap lightSwitchKey = contentPane.getActionMap();
		lightSwitchKey.put("lightSwitch", lightSwitchListener);
		this.requestFocus();
		// end of 't' key press
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		if(lightSwitchListener.lightMode() == 0)
		{
			globalAmbient = new float[] { 0.7f, 0.7f, 0.7f, 0.0f };
		}
		else
		{
